...
import (
	"context"
	"github.com/betonetotbo/go-expert-labs-auctions/configuration/database/mongodb"
	"github.com/betonetotbo/go-expert-labs-auctions/internal/infra/api/web/controller/auction_controller"
	"github.com/betonetotbo/go-expert-labs-auctions/internal/infra/api/web/controller/bid_controller"
	"github.com/betonetotbo/go-expert-labs-auctions/internal/infra/api/web/controller/user_controller"
	"github.com/betonetotbo/go-expert-labs-auctions/internal/infra/database/auction"
	"github.com/betonetotbo/go-expert-labs-auctions/internal/infra/database/bid"
	"github.com/betonetotbo/go-expert-labs-auctions/internal/infra/database/user"
